...
const Preloader = () => {
    useGSAP(() => {
        ...
        gsap.fromTo(".up", {yPercent: -50, opacity: 0}, {yPercent: 0, opacity: 1, delay: .5, duration: 1.6})
        gsap.fromTo(".bot", {yPercent: 50, opacity: 0}, {yPercent: 0, opacity: 1, delay: .5, duration: 1.6})
